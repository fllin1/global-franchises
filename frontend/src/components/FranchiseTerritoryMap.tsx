...
export default function FranchiseTerritoryMap({ data }: { data: TerritoryData }) {
    ...
    const filteredList = useMemo(() => {
        ...
        return []; // Show nothing or all? Let's show states list if nothing selected
    ...
    return (
        <div className="flex h-full">
            ...
            <div className="flex-1 relative bg-slate-100">
                 {/* Use a key to force re-render when center changes drastically if needed, 
                     but MapUpdater handles view changes */}
                 <MapContainer 
                    center={mapCenter} 
                    zoom={4} 
