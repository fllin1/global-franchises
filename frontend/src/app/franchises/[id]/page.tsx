...
function ContentList({ content }: { content: any }) {
    if (!content) return <p className="text-slate-400 italic">Information not available.</p>;
    ...
    if (items.length === 0) return <p className="text-slate-400 italic">Information not available.</p>;
